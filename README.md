...
```
cd existing_repo
git clone https://gitlab.com/raphael.kliyanage/cabinet-emploi.git main
```

with ssh
```
cd existing_repo
git clone git@gitlab.com:raphael.kliyanage/cabinet-emploi.git main
```

Then you need install the modules on your local project:
```
cd existing_repo
npm install
ng serve
...
Open your favorite web browser and go to the following URL: http://localhost:4200
